    ...
    <div className="min-h-screen bg-slate-50/50 pb-16 pt-6">
      ...
      <div className="container max-w-[1440px] mx-auto px-4 sm:px-6 mb-6 no-print">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-sm">
          <div>
            <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-indigo-50 border border-indigo-100 text-xs font-semibold text-indigo-700 mb-1.5">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-2 text-xs sm:text-sm font-semibold rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 transition border border-slate-200 shadow-xs"
            ...
            <button
              type="button"
              onClick={handleReset}
              className="inline-flex items-center gap-1.5 px-3 py-2 text-xs sm:text-sm font-semibold rounded-lg hover:bg-slate-100 text-slate-500 transition border border-transparent"
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 text-xs sm:text-sm font-semibold rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white transition shadow-sm hover:shadow disabled:opacity-60"
            >
              <Sparkles size={16} />
